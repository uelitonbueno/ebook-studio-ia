...
const ebook = { title: "Guia de Teste", subtitle: "Uma edição de demonstração", genre: "Educação", targetAudience: "Pessoas curiosas" };
...
describe("exportadores de e-book", () => {
  ...
  it("gera um EPUB com manifesto e capítulo", async () => {
    ...
    expect(archive.file("OEBPS/chapter-1.xhtml")).toBeTruthy();
